...
class LearningAgent(Agent):
    ...
    def get_max_q(self, state):
        """ The get_max_Q function is called when the agent is asked to find the
            maximum Q-value of all actions based on the 'state' the smart-cab is in. """
    ...
    def choose_action(self, state):
        """ The choose_action function is called when the agent is asked to choose
            which action to take, based on the 'state' the smart-cab is in. """
        ...
        #   Otherwise, choose an action with the highest Q-value for the current state
            ...
            if self.epsilon > random.random():
                ...
                action = random.choice([k for k, v in self.Q[state].items() if v == self.get_max_q(state)])
        return action
